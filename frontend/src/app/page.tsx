      ...
      <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start">
        ...
        <div className="flex gap-4 items-center flex-col sm:flex-row">
          <a
            ...
            href="https://vercel.com/new?utm_source=create-next-index&utm_medium=appdir-template-tw&utm_campaign=create-next-index"
            target="_blank"
          ...
          <a
            ...
            href="https://nextjs.org/docs?utm_source=create-next-index&utm_medium=appdir-template-tw&utm_campaign=create-next-index"
            target="_blank"
            rel="noopener noreferrer"
          >
            Read our docs
